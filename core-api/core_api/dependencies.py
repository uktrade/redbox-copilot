...
def get_redbox(
    all_chunks_retriever: Annotated[
        AllElasticsearchRetriever, Depends(get_all_chunks_retriever)
    ],
    parameterised_retriever: Annotated[
        ParameterisedElasticsearchRetriever, Depends(get_parameterised_retriever)
    ],
    env: Annotated[Settings, Depends(get_env)],
) -> Redbox:
